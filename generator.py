...
def train(model1, dl, tokenizer1, num_epochs=10):
    ...
    for epoch in range(num_epochs):
        ...
        for batch in loop:
            bio, boo = batch #! FOR DETAIL ON THESE SEE LINE 87
...
if __name__ == '__main__':
    ...
    ds = CombiDataset('./data/generated_data/generator/blen_train2/0_0_master_train_clean.txt', blen_tokenizer, max_length)
